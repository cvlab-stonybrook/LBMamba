...
@register_model
def vim_tiny_patch16_224_bimambav2_final_pool_mean_div2(pretrained=False, **kwargs):
    model = VisionMamba(
        patch_size=16, embed_dim=192, depth=24, rms_norm=True, residual_in_fp32=True,
        fused_add_norm=True, final_pool_type='mean', if_abs_pos_embed=True, if_rope=False,
        if_rope_residual=False, bimamba_type="v2", if_cls_token=False, if_divide_out=True,
...
@register_model
def vim_small_patch16_224_bimambav2_final_pool_mean_div2(pretrained=False, **kwargs):
    model = VisionMamba(
...
@register_model
def vim_base_patch16_224_bimambav2_final_pool_mean_div2(pretrained=False, **kwargs):
    model = VisionMamba(
